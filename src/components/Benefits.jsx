                ...
                key={item.id}>
                    <div className="relative z-2 flex flex-col min-h-[22rem] p-[2.4rem]">
                      ...
                      <div className="flex items-center mt-auto">
                        ...
                        alt={item.title}
                        />
                        <p className="ml-auto font-code font-bold text-n-1
                        text-xs uppercase tracking-wider">Explore More</p>
                        <Arrow/>
                        </div>
                    </div>
                    ...
                    >
                      <div className="absolute inset-0.5 opacity-10
