  ...
  return (
    <Section id="how-to-use">
      <div className="container ">
        <Heading
        title="Generative AI made for Craeatoes"
        ...
        <div className="relative ">
            ...
            rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
                ...
                <div className="relative z-1 max-w-[17rem] ml-auto">
                    ...
                    <ul className="body-2">
                        {brainwaveServices.map((item,index)=>(
                          ...
                          >
                            <img height={24} width={24} alt="" src={check}/>
                ...
                lg:left-1/2 lg:right-auto lg:bottom-0 lg:translate-x-1/2 "/>
            </div>
        ...
        <div className="relative z-1 grid gap-5 lg:grid-cols-2">
          ...
          <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
            ...
            md:h-[25rem] " >
                <img src={service3} height={400} width={520} alt="Scary robot"
