...
import {heroBackground} from "../Assets/assets"
            ...
            text-center mb-[4rem] md:mb-20 lg:mb:[6rem]">
                ...
                Chatting with  {" "} 
                    <span className="inline-block relative "> 
                      Brainwave{" "} 
                    <img 
                    src={curve} className="absolute top-full left-0 w-full
                    xl:-mt-2" width={634} height={28} alt="Curve"/>
                </span>
                </h1>
                    ...
                    <div className="relative bg-n-8 rounded-[1rem]">
                        ...
                        md:aspect-[688/490] lg:aspect-[1024/490]">
                            ...
                            <ScrollParallax isAbsolutelyPositioned>
                                ...
                                px-1 py-1 bg-n-9/10 backdrop:blur border border-n-1/10 rounded-2xl xl:flex">
                            ...
                            <ScrollParallax isAbsolutelyPositioned>
                                ...
                                w-[18rem] xl:flex" title="Code generating"/>
                            </ScrollParallax>
                        </div>
                    </div>
                    <Gradient/>
